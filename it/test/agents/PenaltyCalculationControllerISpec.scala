...
class PenaltyCalculationControllerISpec extends IntegrationSpecCommonBase with AuthWiremockStubs with PenaltiesWiremockStubs {
  ...
  "return page with calculation (lower rate) when penalty is paid and logged in as agent" in {
  ...
  "return page with calculation (lower rate) when penalty is an estimate and logged in as agent" in {
    mockDelegatedResponse()
  ...
  "return page with calculation (higher rate) when penalty is due and logged in as agent" in {
    mockDelegatedResponse()
  ...
  "return page with calculation (higher rate) when penalty is an estimate and logged in as agent" in {
    mockDelegatedResponse()
  ...
  "return page with calculation (higher rate) when penalty is paid and logged in as agent" in {
    mockDelegatedResponse()
