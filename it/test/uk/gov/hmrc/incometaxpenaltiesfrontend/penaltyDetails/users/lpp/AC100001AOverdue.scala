...
object AC100001AOverdue extends UserDetailsData {

  override val nino: String = AC100001A.nino
  override val expectedNumberOfLPPPenaltyCards: Int = AC100001A.expectedNumberOfLPPPenaltyCards
  override val expectedNumberOfLSPPenaltyCards: Int = AC100001A.expectedNumberOfLSPPenaltyCards
