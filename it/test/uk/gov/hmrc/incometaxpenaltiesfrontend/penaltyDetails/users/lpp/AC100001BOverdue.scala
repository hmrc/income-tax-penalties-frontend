...
object AC100001BOverdue extends UserDetailsData {

  override val nino: String = AC100001B.nino
  override val expectedNumberOfLPPPenaltyCards: Int = AC100001B.expectedNumberOfLPPPenaltyCards
  override val expectedNumberOfLSPPenaltyCards: Int = AC100001B.expectedNumberOfLSPPenaltyCards
  ...
  def penaltyCard0ExpectedContent(card: Element): Unit = {
    ...
    validateSummary(cardRows.get(0), "Pay penalty by", "19 March 2026")
  ...
  override val timeMachineDate: String = "20/05/2026"
}
