...
object AC210000D extends UserDetailsData {
  ...
  def penaltyCard0ExpectedContent(card: Element): Unit = {
    validatePenaltyCardTitle(card, expectedTitle = "Second late payment penalty: £6.02")
    ...
    validateSummary(cardRows.get(3), "Income Tax paid", "20 March 2028")
  ...
  override val timeMachineDate: String = "29/03/2028"
}
