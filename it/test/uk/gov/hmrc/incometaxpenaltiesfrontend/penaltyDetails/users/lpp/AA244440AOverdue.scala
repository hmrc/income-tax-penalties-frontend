...
object AA244440AOverdue extends UserDetailsData {

  override val nino: String = AA244440A.nino
  override val expectedNumberOfLPPPenaltyCards: Int = AA244440A.expectedNumberOfLPPPenaltyCards
  override val expectedNumberOfLSPPenaltyCards: Int = AA244440A.expectedNumberOfLSPPenaltyCards
  
  def penaltyCard0ExpectedContent(card: Element): Unit = {
    validatePenaltyCardTitle(card, expectedTitle = "Second late payment penalty: £46.02")
    validateCardTag(card, expectedTag = "£24.00 overdue")
  ...
  override val expectedPenaltyCardsContent: Map[Int, Element => Unit] = Map(
    ...
    1 -> AA244440A.penaltyCard1ExpectedContent,
    2 -> AA244440A.penaltyCard2ExpectedContent
  )

  override val expectedOverviewText: String =
    "Overview Your account has a late payment penalty Check what you owe"

  override val timeMachineDate: String = "20/04/2028"
}
