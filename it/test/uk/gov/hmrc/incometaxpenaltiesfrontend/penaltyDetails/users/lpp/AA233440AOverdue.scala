...
object AA233440AOverdue extends UserDetailsData {

  override val nino: String = AA233440A.nino
  override val expectedNumberOfLPPPenaltyCards: Int = AA233440A.expectedNumberOfLPPPenaltyCards
  override val expectedNumberOfLSPPenaltyCards: Int = AA233440A.expectedNumberOfLSPPenaltyCards
  ...
  override val expectedPenaltyCardsContent: Map[Int, Element => Unit] = Map(
    ...
    1 -> AA233440A.penaltyCard1ExpectedContent
  )

  override val expectedOverviewText: Boolean => String = AA233440A.expectedOverviewText
