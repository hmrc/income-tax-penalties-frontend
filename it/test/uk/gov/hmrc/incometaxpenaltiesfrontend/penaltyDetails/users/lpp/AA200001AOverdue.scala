...
object AA200001AOverdue extends UserDetailsData {

  override val nino: String = AA200001A.nino
  override val expectedNumberOfLSPPenaltyCards: Int = AA200001A.expectedNumberOfLSPPenaltyCards
  ...
  def penaltyCard1ExpectedContent(card: Element): Unit = {
    ...
    validateSummary(cardRows.get(0), "Pay penalty by", "4 April 2029")
  ...
  override val expectedPenaltyCardsContent: Map[Int, Element => Unit] = Map(
    0 -> AA200001A.penaltyCard0ExpectedContent,
    1 -> penaltyCard1ExpectedContent
  )

  override val expectedOverviewText: String = AA200001A.expectedOverviewText
  override val timeMachineDate: String = "20/05/2029"
}
