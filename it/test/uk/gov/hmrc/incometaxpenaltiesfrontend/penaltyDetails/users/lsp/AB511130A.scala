...
object AB511130A extends UserDetailsData {
  ...
  override val numberOfPaidFinancialPenalties: Int = 2

  override val expectedNumberOfLSPPenaltyCards: Int = 8
  ...
  def penaltyCard4ExpectedContent(card: Element): Unit = {
    ...
    validateSummary(cardRows.get(5), "Appeal status", "Under review")
  }
  ...
  def penaltyCard6ExpectedContent(card: Element): Unit = {
  ...
  def penaltyCard7ExpectedContent(card: Element): Unit = {
  ...
  override val expectedPenaltyCardsContent: Map[Int, Element => Unit] = Map(
    ...
    6 -> penaltyCard6ExpectedContent,
    7 -> penaltyCard7ExpectedContent
  )
