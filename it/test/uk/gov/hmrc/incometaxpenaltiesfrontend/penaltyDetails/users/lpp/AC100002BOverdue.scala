...
object AC100002BOverdue extends UserDetailsData {

  override val nino: String = AC100002B.nino
  override val expectedNumberOfLSPPenaltyCards: Int = AC100002B.expectedNumberOfLSPPenaltyCards
  override val expectedNumberOfLPPPenaltyCards: Int = AC100002B.expectedNumberOfLPPPenaltyCards
  ...
  override val expectedOverviewText: String = AC100002B.expectedOverviewText
