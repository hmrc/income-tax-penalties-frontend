...
object AC200000DOverdue extends UserDetailsData {

  override val nino: String = AC200000D.nino
  override val expectedNumberOfLSPPenaltyCards: Int = AC200000D.expectedNumberOfLSPPenaltyCards
  override val expectedNumberOfLPPPenaltyCards: Int = AC200000D.expectedNumberOfLPPPenaltyCards
  ...
  def penaltyCard0ExpectedContent(card: Element): Unit = {
    ...
    validateSummary(cardRows.get(3), "Income Tax paid", "Payment plan proposed")
  ...
  override val expectedOverviewText: String = AC200000D.expectedOverviewText

  // timeMachine date set after penaltyChargeDueDate (2028-04-03) to produce Overdue tag
