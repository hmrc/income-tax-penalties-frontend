...
object AA100011AOverdue extends UserDetailsData {

  override val nino: String = AA100011A.nino
  override val expectedNumberOfLSPPenaltyCards: Int = AA100011A.expectedNumberOfLSPPenaltyCards
  override val expectedNumberOfLPPPenaltyCards: Int = AA100011A.expectedNumberOfLPPPenaltyCards
  ...
  override val expectedOverviewText: String = AA100011A.expectedOverviewText
