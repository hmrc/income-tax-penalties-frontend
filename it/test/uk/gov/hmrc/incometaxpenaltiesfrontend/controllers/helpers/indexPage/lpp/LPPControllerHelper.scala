...
trait LPPControllerHelper extends ControllerISpecHelper {
  ...
  val lppUsers: Map[String, UserDetailsData] = Map(
    ...
    "AA100001B-overdue" -> AA100001BOverdue,
    ...
    "AC100001B-overdue" -> AC100001BOverdue,
    "AC100002A-overdue" -> AC100002AOverdue,
  ...
  def validateNoLSPPenalties(document: Document, isAgent: Boolean = false): Unit = {
    ...
    val expectedLSPContent = "You do not have any active late submission penalties."
