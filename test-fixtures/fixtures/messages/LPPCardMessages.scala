...
object LPPCardMessages {
  ...
  sealed trait Messages { this: i18n =>
    ...
    val cardTitleSupplementaryPenaltyLPP2: String => String = amount => s"Additional second late payment penalty: £$amount"
    ...
    val cardLinksCheckIfCanAppeal = "Appeal this penalty"
  ...
  object Welsh extends Messages with Cy {
    ...
    override val cardLinksCheckIfCanAppeal = "Apelio yn erbyn y gosb hon"
