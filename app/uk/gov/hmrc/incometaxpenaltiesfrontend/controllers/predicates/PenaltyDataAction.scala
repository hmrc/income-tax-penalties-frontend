...
import uk.gov.hmrc.incometaxpenaltiesfrontend.models.{AuthenticatedUserWithPenaltyData, CurrentUserRequest}
...
class PenaltyDataAction @Inject()(val penaltiesService: PenaltiesService,
                                 ...
                                 (implicit val executionContext: ExecutionContext) extends ActionRefiner[CurrentUserRequest, AuthenticatedUserWithPenaltyData] {
