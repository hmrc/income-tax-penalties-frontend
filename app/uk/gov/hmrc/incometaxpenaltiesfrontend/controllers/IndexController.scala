...
import uk.gov.hmrc.incometaxpenaltiesfrontend.utils.{CurrencyFormatter, EnrolmentKeys, ImplicitDateFormatter}

import javax.inject.Inject
import scala.concurrent.{ExecutionContext, Future}

class IndexController @Inject()()(implicit ec: ExecutionContext,
  ...
  def redirectToAppeals(penaltyId: String, isLPP: Boolean = false, isFindOutHowToAppealLSP: Boolean = false,
